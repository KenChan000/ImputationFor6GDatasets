...
from baselines.IGRM.training.baseline import baseline_mdi
...
def main():
    ...
    for args.data in ['concrete','housing','wine','heart','DOW30','ecommerce','diabetes','yacht']:
        for args.method in ['knn', 'svd', 'mice', 'spectral']:
            if args.best_level:
