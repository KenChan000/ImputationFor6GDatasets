...
from baselines.IGRM.training.gnn_mdi import train_gnn_mdi
from baselines.IGRM.uci.uci_subparser import add_uci_subparser
from baselines.IGRM.utils.utils import auto_select_gpu
import pickle
...
def main():
    ...
    for dataset in ['concrete','housing','wine','heart','DOW30','ecommerce','diabetes','yacht']:
        ...
        for i in range(0,5):
            ...
            if args.domain == 'uci':
                from baselines.IGRM.uci.uci_data import load_data
                data = load_data(args)
